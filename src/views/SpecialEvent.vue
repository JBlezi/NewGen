<template>
  ...
  <section class="mt-12 mb-12 md:my-24">
    <div class="px-8 md:px-16">
      ...
      <p class="font-medium text-lg md:text-xl lg:text-2xl">The {{ heroHeading }} will take place on <span class="font-bold">{{ date }} at Moviemento Kino, Kottbusser Damm 22, Berlin.</span></p>
    </div>
  </section>
  <section class="mt-12 mb-12 md:my-24">
