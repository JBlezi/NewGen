<template>
  <section class="w-screen h-32 my-8 overflow-x-hidden" id="sponsor-slider" @mousedown="handleMouseDown" @mousemove="handleMouseMove" @mouseup="handleMouseUp" @touchstart="handleTouchStart"
