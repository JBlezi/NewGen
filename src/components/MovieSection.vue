<template>
  <section class="px-8 my-16">
    <div class="text-3xl font-bold text-main mb-4 italic">
      {{ movie.title }}
    </div>
    <div class="">
      <img :src="movie.poster" alt="Movie Poster" class="h-full min-w-full"/>
    </div>
    <div class="font-medium flex justify-between mb-4">
      <div>
