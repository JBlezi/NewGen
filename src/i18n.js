...
const messages = {
  en: {
    ...
    submissions: {
      ...
      submissions7: 'be made in one or more than one of the Chinese languages (Mandarin, Cantonese, or other dialects); or',
      submissions8: 'be produced, directed, written, ﬁlmed, or acted in by at least one ethnic Chinese or Asian ﬁlmmaker (regardless of the place of residence).',
      submissions9: 'The submitted film must provide English subtitles/captions if the dialogues are not in English.',
      submissions10: 'The submitted film should be made after January 1, 2023.',
      submissions11: 'The submitted film should run no longer than 30 minutes.',
  ...
  zh: {
    ...
    submissions: {
      ...
      submissions8: '影片的主要对白为华语（包括各地方言）',
      submissions9: '参赛作品若非全英语对白，则必须附有英语字幕（中英文字幕最佳）',
      submissions10: '参赛作品需在2023年1月1日后完成制作',
      submissions11: '参赛作品为短片，时长不超过30分钟',
